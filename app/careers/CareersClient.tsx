        ...
        <div className="-mt-6">
            ...
            <div className="p-5 px-24 flex justify-center items-center flex-col w-full" >
                <div className="w-[75%] text-center my-3 ">
                    <div className="border-2 text-white text-[1.3rem] h-[160px] bg-[#cb1670] rounded-lg p-8">
            ...
            <div className="p-5 px-24 flex justify-center items-center flex-col w-full" >
                <div className="w-[75%] my-3 ">
                    <div className="border-2 text-black text-[1.3rem] bg-white rounded-lg p-4">
                    ...
                    <h2 className="text-lg font-normal text-[#000000] mt-2 mb-2">Key Responsibilities:</h2>
                    <ol>
                    ...
                    <ol>
                        ...
                        <p className="text-base font-light mt-2">This is an exciting opportunity for someone who is looking for a challenging role in a dynamic and fun environment. If you have a passion for working with children and a proven track record in restaurant management, we would love to hear from you.</p>
                        <p className="text-base font-light mt-2">Please apply with your CV and a cover letter highlighting your relevant experience.</p>
